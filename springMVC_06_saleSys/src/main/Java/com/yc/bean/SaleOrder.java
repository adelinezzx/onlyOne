...
public class SaleOrder implements java.io.Serializable {
	...
	public SaleOrder(Long odrCustomerId, String odrCustomerName, String odrDeliverAddr, Date odrDeliverDate,
			String odrStatus) {
	...
	// 而 对应的 odrOrderDateString并没有值，所以等下 gson生成 json字符串时，
	// 因为odrOrderDateString是null
	...
	public String toString() {
		return "SaleOrder [odrId=" + odrId + ", odrCustomerId=" + odrCustomerId + ", odrCustomerName=" + odrCustomerName
